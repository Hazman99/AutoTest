from ninja import NinjaAPI, UploadedFile, File, Form, Query
from ninja.responses import Response
from lms_core.schema import CourseSchemaOut, CourseMemberOut, CourseSchemaIn, HelloResponse
from lms_core.schema import CourseContentMini, CourseContentFull
from lms_core.schema import CourseCommentOut, CourseCommentIn, CourseFilter
from lms_core.models import Course, CourseMember, CourseContent, Comment, Courses
...
api_test = NinjaAPI(version='2.0.0') 
apiAuth = HttpJwtAuth()


@api_test.get("/hello", response=HelloResponse)
def hello(request):
...
@apiv1.get('courses/', response=list[CourseSchemaOut], auth=apiAuth)
